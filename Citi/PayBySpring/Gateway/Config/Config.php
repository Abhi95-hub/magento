...
namespace Citi\PayBySpring\Gateway\Config;
...
{
    const WEB_HOOK_RESPONSE_URL = 'citi/webhook/response';
    ...
    const API_SPRING_PRODUCTION = 'api_spring_sandbox';
    const API_SPRING_SANDBOX = 'api_spring_sandbox';
