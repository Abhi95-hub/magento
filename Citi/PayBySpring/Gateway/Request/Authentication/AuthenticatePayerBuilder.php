...
namespace Citi\PayBySpring\Gateway\Request\Authentication;

use Magento\Framework\Session\SessionManagerInterface;
use Magento\Framework\UrlInterface;
use Magento\Payment\Gateway\Request\BuilderInterface;
use Citi\PayBySpring\Gateway\Request\ThreeDSecure\CheckDataBuilder;

class AuthenticatePayerBuilder implements BuilderInterface
{
    public const RESPONSE_URL = 'citi/threedsecureV2/response';
