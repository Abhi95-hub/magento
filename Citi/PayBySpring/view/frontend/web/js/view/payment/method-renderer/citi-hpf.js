...
define(
    ...
    function (
        ...
        return ccFormComponent.extend({
            defaults: {
                template: 'Citi_PayBySpring/payment/citi-hpf',
                active: false,
                adapterLoaded: false,
                buttonTitle: null,
            ...
            getCardFields: function () {
                return {
                    card: {
                        cardNumber: "#citi_hpf_cc_number",
                        number: "#citi_hpf_cc_number",
                        expiryMonth: "#citi_hpf_expiration",
                        expiryYear: "#citi_hpf_expiration_yr",
                        securityCode: "#citi_hpf_cc_cid"
                    }
                }
            },
            ...
            createChildrenComponents: function (items) {
                ...
                return items.map($.proxy(function (item) {
                    return {
                        ...
                        component: 'Citi_PayBySpring/js/view/payment/' + item.component,
                        config: {
                            id: this.item.method,
