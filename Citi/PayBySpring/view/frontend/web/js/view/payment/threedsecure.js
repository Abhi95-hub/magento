...
define([
    ...
    'uiComponent',
    'mage/url',
    'Citi_PayBySpring/js/action/check-enrolment',
    ...
    return Component.extend({
        defaults: {
            template: 'Citi_PayBySpring/threedsecure/iframe',
            iframeSelector: '[data-role=citi-threedsecure-iframe]'
        },
        onComplete: null,
        onError: null,
        onCancel: null,
        ...
        threeDSecureOpen: function () {
            ...
            window.citiThreeDSecureClose = $.proxy(this.iframeFormCompleted, this);
        ...
        isEnrolled: function (response) {
            if (response.result == "Y") {
                ...
                this.iframe.attr('src', url.build('citi/threedsecure/form'));
