...
namespace Citi\PayBySpring\Controller\Webhook;
    ...
    public function execute()
    {
        ...
        try {
            ...
            $errorMessage = sprintf(
                __("Spring By Citi Payment Gateway Services WebHook Exception: '%s'"),
                $e->getMessage()
            );
        ...
        $logMessage = __("Spring By Citi Payment Gateway Services WebHook Success");
