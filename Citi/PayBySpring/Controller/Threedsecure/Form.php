...
namespace Citi\PayBySpring\Controller\Threedsecure;
...
use Citi\PayBySpring\Gateway\Response\ThreeDSecure\CheckHandler;
...
class Form extends Action
{
    ...
    public function execute()
    {
        ...
        $block = $this->layoutFactory
            ->create()
            ->createBlock(\Citi\PayBySpring\Block\Threedsecure\Form::class);

        $payment = $this->session->getQuote()->getPayment();

        $block
            ->setTemplate('Citi_PayBySpring::threedsecure/form.phtml')
