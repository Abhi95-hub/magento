...
namespace Citi\PayBySpring\Observer;
...
use Citi\PayBySpring\Gateway\Config\ConfigFactory;
use Citi\PayBySpring\Model\SelectedStore;
    ...
    public function execute(Observer $observer)
    {
        ...
        try {
            ...
            foreach ($this->methods as $method => $label) {
                /** @var \Citi\PayBySpring\Gateway\Config\Config $config */
            ...
            $this->logger->critical('Error occurred while testing Spring By Citi configuration: ' . $e->getMessage(), [
                'exception' => $e
            ]);
        }
    }
