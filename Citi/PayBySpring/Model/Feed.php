...
class Feed
{
    const XML_FEED_URL_PATH = 'citi/adminnotification/feed_url';
    const XML_FREQUENCY_PATH = 'citi/adminnotification/frequency';
    const CACHE_KEY = 'citi_admin_notifications_lastcheck';
